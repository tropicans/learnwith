...
export const LIVE_CLASS_MODULES: LiveModule[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Lakukan pengujian HTTP POST sederhana untuk memastikan model merespons permintaan chat completion. Ganti [VIRTUAL_API_KEY] dengan key Anda dan [NAMA_MODEL] dengan model yang terdaftar di 9Router.',
        ...
        instructions: [
          ...
          'Ganti <code>[NAMA_MODEL]</code> dengan nama model yang telah dipetakan di dashboard 9Router Anda (contoh: <code>gemini-2.5-flash</code>, <code>gemini-1.5-flash</code>, atau model pilihan Anda).',
    ...
    steps: [
      {
        ...
        instructions: [
          ...
          'Pilih model default: masukkan nama model yang Anda petakan di 9Router (<code>[NAMA_MODEL]</code>, misal: <code>gemini-2.5-flash</code> atau model pilihan Anda).',
