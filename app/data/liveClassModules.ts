...
export const LIVE_CLASS_MODULES: LiveModule[] = [
  ...
  },
  {
    ...
    subtitle: 'Instalasi hermes-cli, environment verification, dan system doctor check',
    estimatedMinutes: 30,
    badgeLabel: 'Modul 7',
    badgeClass: 'badge-primary',
    icon: '🤖',
    checkpointTitle: 'Checkpoint 7: Hermes Doctor Report Passed',
    checkpointDescription: 'Laporan diagnostik sistem hermes doctor menyatakan status hijau tanpa dependensi yang hilang.',
    steps: [
      {
        nodeId: '7A',
        title: 'Instalasi Global CLI Hermes Agent',
        badgeLabel: 'NPM Package',
        badgeClass: 'badge-primary',
        description: 'Pasang package hermes-cli secara global menggunakan npm dari registry resmi workshop.',
        command: 'npm install -g hermes-agent-cli@latest',
        commandLanguage: 'PowerShell',
        taskId: 'm7-install-cli',
        checklistLabel: 'Package hermes-agent-cli terpasang secara global',
      },
      {
        nodeId: '7B',
        title: 'Verifikasi Versi & Eksekusi System Doctor',
        badgeLabel: 'Diagnostik',
        badgeClass: 'badge-success',
        description: 'Jalankan pemeriksaan kesehatan lingkungan kerja untuk memastikan Node.js, Git, dan koneksi local gateway siap.',
        command: 'hermes doctor --verbose',
        commandLanguage: 'PowerShell',
        outputBadge: {
        ...
        checklistLabel: 'Perintah hermes doctor melaporkan status ALL CHECKS PASSED',
      },
      {
        nodeId: '7C',
        title: 'Inisialisasi Direktori Workspace Hermes',
        badgeLabel: 'Struktur Folder',
        badgeClass: 'badge-info',
        description: 'Buat direktori kerja khusus agent di folder dokumen pengguna untuk menyimpan state, memori, dan tools.',
        command: 'New-Item -ItemType Directory -Path "$HOME/hermes-workspace" -Force; Set-Location "$HOME/hermes-workspace"',
        commandLanguage: 'PowerShell',
        taskId: 'm7-init-workspace',
        checklistLabel: 'Direktori kerja hermes-workspace berhasil dibuat dan diakses',
      },
    ],
  },
  {
